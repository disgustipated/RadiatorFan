...
#define mqtt_user "radiatorfan"
#define mqtt_password "radiatorfan"
#define topic "home/climate/"

const int  statusPagePort = 8266;
const char* SOFTWARE_VERSION = "0.1 Radiator Fan";
const char* DEVICENAME = "RadiatorFan1"; 
const int SENSOR_INFO_LED_PIN = 5;
const int WIFI_INFO_LED_PIN = 2;
const int WIFI_RESET_PIN = 14;
const int FAN_ACTIVATE_PIN = 12;
...
void setup() {
  ...
  pinMode(FAN_ACTIVATE_PIN,OUTPUT);
  digitalWrite(FAN_ACTIVATE_PIN,HIGH);
  ...
  //Alarm.alarmRepeat(7,0,0, activatePump); //runs at 7am
  //Alarm.alarmRepeat(12,30,0, activatePump); //runs at 1230
